...
class ProductServiceTest {
    ...
    void shouldFindProductByNameSuccessfully() {
        when(productRepository.findByName("Produto Teste")).thenReturn(Optional.of(productEntity));
    ...
    void shouldUpdateProductSuccessfully() {
        ...
        ReturnProductDTO result = productService.updateProduct("SKU123", updateDTO);
